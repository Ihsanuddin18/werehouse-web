      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
           ...
           <!-- Tambahkan jam dan tanggal di sini -->
           <div id="clock" style="color: white; margin-left: 30px; margin-right: auto;"></div>
        </form>
              <script>
                        ...
                        // Formatting the time and date to two digits if less than 10
                    ...
                    // Call the function to initially set the clock
                    updateClock();
                </script>
